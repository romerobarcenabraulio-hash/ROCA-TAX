window.ROCA_EDITORIAL_SECTIONS = [
  ...
  },
  {
    ...
    body:`
      ...
      <ul>
        ...
        <li>Personas que transmitieron o mantienen el oficio.</li>
        <li>Herramientas, técnicas y formas de trabajo que expliquen la evolución de ROCA.</li>
        <li>Piezas, procesos y momentos que representen la identidad del taller.</li>
        <li>Comparativos del antes y después cuando aporten contexto real.</li>
      </ul>
      <p>Una misma fotografía puede funcionar como evidencia operativa y como patrimonio visual. La selección editorial debe privilegiar contexto, oficio e identidad.</p>
    `
  },
  {
  ...
  {
    id:"procesos", nav:"Cómo trabaja ROCA", title:"Cómo recorre una pieza el taller", eyebrow:"Proceso general",
    lead:"El proceso cambia según especie, condición, tipo de montaje y procedencia, pero la lectura general permite entender cómo se conectan las áreas.",
    body:`
      <p class="callout">Recepción e identificación → preparación / curtiduría → forma y adaptación → montaje → espera / secado → retoque → control final → entrega</p>
      <h2>1. Entrada y trazabilidad</h2><p>La pieza se identifica, se relaciona con su propietario y documentación disponible, se fotografía cuando corresponde y se dirige a conservación, proceso o espera.</p>
      <h2>2. Preparación y curtiduría</h2><p>La piel pasa por las etapas necesarias de hidratación, pickle, rebajado, alumbre y bateado según su condición y espesor. Las recetas y variantes técnicas viven en el bloque operativo correspondiente.</p>
      <h2>3. Forma, adaptación y montaje</h2><p>Se selecciona o fabrica la forma, se adapta a medidas reales y se prepara la estructura necesaria. Montaje integra piel, forma, orejas, reparaciones, adhesivos, costura y posición.</p>
      <h2>4. Retoque y cierre</h2><p>Después de secado y estabilización, la pieza se limpia, resana, pinta y termina. El cierre requiere que la pieza, el estado de pago y la trazabilidad de entrega sean consistentes.</p>
      <h2>Regla de operación</h2><p>Montar requiere pago y forma definida/lista. Entregar requiere pago completo. BIWO mantiene el dato comercial y la etapa registrada debe coincidir con la realidad física.</p>
    `
  },
  {
  ...
  {
    id:"machotes-guias", nav:"Machotes y guías", title:"Qué se preserva y cómo se usa", eyebrow:"Matriz documental de ROCA",
    ...
    body:`
      <table><thead><tr><th>Tipo</th><th>Uso</th><th>Ejemplo</th><th>Regla</th></tr></thead><tbody>
        ...
        <tr><td>Registro / evidencia</td><td>Demostrar lo que ocurrió en un caso.</td><td>Contrato firmado, recibo, foto, bitácora, expediente de pieza.</td><td>Archivar; no inflar el HTML con el caso individual.</td></tr>
      </tbody></table>
      <h2>Regla para machotes</h2>
      <p>Los machotes deben responder cinco cosas: cuándo se usan, qué se llena, quién los prepara, quién firma y qué evidencia queda. Los jurídicos se mantienen como borrador/referencia hasta validación legal para uso definitivo.</p>
    `
  }
];
