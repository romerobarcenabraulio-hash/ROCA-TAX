window.ROCA_SOURCE_DOCS = [
  {
    ...
    related: [
      ...
      },
      {
        ...
        label: "Bases",
        areaId: "AREA-BAS",
        controlIds: ["REQ-COM-01..15","BAS-AREA-01..12"],
        sourceControlIds: ["BAS-AREA-01..09"],
        evidenceIds: ["EVID-BAS-01","EVID-BAS-02","EVID-BAS-03"],
        action: "MERGE_WITHOUT_LOSS",
        page: 183,
        pageEnd: 207,
        locator: "PDF físico pp. 183-207 · módulo BAS; etapas 08-09 en p. 175",
        proof: "Módulo BAS formal p. 183-207; etapas 08-09 quedaron en el bloque histórico Retoque y bases p. 175; entrevista Rodolfo p. 380; entrevista Omar p. 381.",
        subLocators: [
          { id:"BAS-GOV", label:"Gobernanza local", page:185, pageEnd:185, action:"CORRECT" },
          { id:"BAS-AREA", label:"Área de trabajo y estaciones", page:186, pageEnd:189, action:"MERGE_WITHOUT_LOSS", controlIds:["BAS-AREA-01..12"], sourceControlIds:["BAS-AREA-01..09"] },
          { id:"EVID-BAS", label:"Evidencia fotográfica", page:190, pageEnd:190, action:"MERGE_WITHOUT_LOSS", evidenceIds:["EVID-BAS-01","EVID-BAS-02","EVID-BAS-03"] },
          { id:"BAS-VERIFY-AREA", label:"Verificación del área", page:191, pageEnd:193, action:"PRESERVE" },
          { id:"BAS-METHOD-08-09", label:"Medición/plancha + bancos/fijación", page:175, pageEnd:175, action:"MOVE" },
          { id:"BAS-METHOD-10-15", label:"Poliuretano, dextrina, malla, terreno y ambientación", page:194, pageEnd:197, action:"MERGE_WITHOUT_LOSS" },
          { id:"BAS-TOOLS", label:"Herramientas, equipo y consumibles", page:198, pageEnd:206, action:"CORRECT" },
          { id:"BAS-VERIFY-METHOD", label:"Verificación de metodología", page:207, pageEnd:207, action:"PRESERVE" },
          { id:"BAS-INTERVIEW-RODOLFO", label:"Entrevista primaria · Rodolfo", page:380, pageEnd:380, action:"MERGE_WITHOUT_LOSS" },
          { id:"BAS-PU-CONFLICT-OMAR", label:"Entrevista primaria · Omar · poliuretano", page:381, pageEnd:381, action:"HOLD_PENDING_EVIDENCE" }
        ]
      },
      {
        ...
        areaId: "AREA-CAR",
        controlIds: ["REQ-COM-01..15","CAR-AREA-01..10"],
        sourceControlIds: ["CAR-AREA-01..10"],
        evidenceIds: ["EVID-CAR-01","EVID-CAR-02"],
        action: "HOLD_PENDING_EVIDENCE",
        page: 208,
        pageEnd: 221,
        locator: "PDF físico pp. 208-221 · módulo CAR",
        proof: "Módulo CAR p. 208-221. El propio master declara método no liberado. La ubicación histórica en espacio de Sr. Pes queda corregida por gobernanza posterior de Retoque.",
        subLocators: [
          { id:"CAR-GOV", label:"Gobernanza propuesta", page:210, pageEnd:210, action:"HOLD_PENDING_EVIDENCE" },
          { id:"CAR-AREA", label:"Área de trabajo preparada", page:211, pageEnd:213, action:"CORRECT", controlIds:["CAR-AREA-01..10"], sourceControlIds:["CAR-AREA-01..10"] },
          { id:"CAR-LOCATION-CONFLICT", label:"Ubicación histórica en espacio Sr. Pes", page:212, pageEnd:220, action:"CORRECT" },
          { id:"EVID-CAR", label:"Evidencia de implementación", page:214, pageEnd:214, action:"HOLD_PENDING_EVIDENCE", evidenceIds:["EVID-CAR-01","EVID-CAR-02"] },
          { id:"CAR-VERIFY-AREA", label:"Verificación preparada", page:215, pageEnd:218, action:"PRESERVE" },
