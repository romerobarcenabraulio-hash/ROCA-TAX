# ROCA TAXIDERMY — Soldadura y Adaptación · libro integral V2
Área ID: AREA-SOL
Estado: WORKING STANDARD / MÉTODO NO LIBERADO

## 0. Identidad y gobernanza
**Función:** resolver uniones y adaptaciones metálicas con control de sujeción, chispas, humos y estabilidad.

**Responsable conocido:** Flaco (alias operativo).

**Recibe:** pieza/estructura que requiere unión o adaptación.  
**Entrega:** unión estable preparada para continuar.
...
La fuente existente dice explícitamente que falta entrevista/demostración del responsable para secuencia, tipo de unión, preparación, consumibles, ajustes, aceptación y retrabajo.
...
Autorización por proceso/equipo y control de trabajo en caliente. Evidencia real pendiente.

## 6. Control/evidencia
Vincular adaptación/incidencia a la orden cuando afecta la pieza. Registrar condición antes/después si la modificación es estructural.
