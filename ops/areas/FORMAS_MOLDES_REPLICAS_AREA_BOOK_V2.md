# ROCA TAXIDERMY — Formas, Moldes y Réplicas · libro integral V2
Área ID: AREA-FMR
Estado: WORKING / NO LIBERAR

## 0. Identidad y gobernanza
**Función:** convertir medidas y geometría en forma, molde o réplica estable y utilizable.

**Responsable conocido:** Omar. Soldadura/adaptación entra como apoyo sólo cuando la pieza lo requiere.

**Recibe:** medidas, patrón/forma, pose o pieza a reproducir.  
**Entrega:** forma, molde o réplica identificada y utilizable a Montaje/u operación solicitante.
...
### Formas de poliuretano
Preparar estructura/molde → encerar → orear → probar lote → dosificar → mezclar → vaciar → curar/enfriar → desmoldar/terminar.

Fuentes de entrevista conservan 20 g totales como prueba de lote y relación base 50/50 en condición cálida. Las variaciones por clima y los tiempos se mantienen en el método técnico controlado; no trasladarlos a una regla global sin contexto.

### Moldes de fibra de vidrio
Preparar forma → múltiples pasadas de cera → orear → preparar/aplicar gelcoat del taller → crear separaciones → laminar fibra → curar → abrir/terminar.

La entrevista de Omar registra alrededor de diez pasadas de cera, gelcoat de resina + talco con consistencia muy espesa y seis capas de fibra como base con posible séptima cuando requiere mayor espesor/resistencia.

### Réplicas
Preparar molde → preparar mezcla de resina/carga → vaciar/distribuir → curar/desmoldar → corregir línea/rebabas → pintar contra referencia.

## 3. Herramientas/equipo
Caladora/corte, taladro y mezclador, báscula, recipientes patrón, moldes, pernos/herrajes, prensas/sargentos, brochas y herramienta de acabado. Inventario y mantenimiento exactos: PARTIAL.

## 4. Materiales/flujo
Triplay, varilla/herrajes, cera desmoldante, componentes A/B, resina, talco/cargas, fibra de vidrio, gelcoat del taller, papel cascarón y materiales de réplica/acabado.

Separar material incorporado, sobrante reutilizable, mezcla reaccionada, envases y residuos por producto real.

## 5. Personas/competencia
Matriz por operación: corte/estructura, encerado, dosificación, mezcla/vaciado, apertura de molde, acabado y liberación.
